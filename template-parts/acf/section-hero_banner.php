...
$poster_url_desktop = esc_url($poster_id_desktop ? wp_get_attachment_image_url($poster_id_desktop, '2k') : '');
$poster_url_mobile = esc_url($poster_id_mobile ? wp_get_attachment_image_url($poster_id_mobile, 'large') : '');
